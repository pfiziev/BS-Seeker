...
============
(1) Reduced index for RRBS, accelerating the mapping speed and increasing mappability
(2) Allowing local alignment with Bowtie 2, increased the mappability

2. Other features
============
- Supported library types
(1) whole genomewide bisulfite sequencing (WGBS)
(2) reduced representative bisulfite sequencing (RRBS)
